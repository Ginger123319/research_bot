...
digraph brainstorming {
    ...
    "Await user next instruction" [shape=doublecircle];
    ...
    "User reviews spec?" -> "Await user next instruction" [label="approved"];
}
```

**The terminal state is user spec approval.** Do NOT invoke any implementation skill. Wait for the user's next instruction.
