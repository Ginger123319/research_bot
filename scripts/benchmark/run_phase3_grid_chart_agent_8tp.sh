#!/bin/bash
# Phase 3 上线验证网格 — xinghan-chart-32b-v1-1-agent 8TP（Agent 数据集）
#
...
#
# 用法：
#   IDEAL_RPS=X.XX bash scripts/benchmark/run_phase3_grid_chart_agent_8tp.sh
...
OUTPUT_BASE="${PROJECT_DIR}/logs/xinghan-chart-32b-v1-1-agent/chart-32b-agent-8tp-phase3_${TIMESTAMP}"
...
echo "========================================================"
echo "Phase 3 上线验证网格 — chart-32b-agent 8TP"
