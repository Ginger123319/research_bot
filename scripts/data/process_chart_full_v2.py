...
PEAK_WINDOWS = [    ("2026-03-13 23:45:00", "2026-03-14 00:15:00", "03-14 峰值00:02 ±15min"),    ("2026-03-11 23:45:00", "2026-03-12 00:15:00", "03-12 峰值00:02 ±15min"),    ("2026-03-12 23:45:00", "2026-03-13 00:15:00", "03-13 峰值00:03 ±15min"),]
...
# ============================================================
# 步骤 1：完整数据转换（read_only_time=True）
# ============================================================
...
| 步骤 | 操作 | 关键参数 |
|------|------|---------|
| 1 | JSONL → all.csv | read_only_time=True，异步拉取 prompt URL |
...
## 验证结论
- model_list 别名验证：JSONL 中只有 `xinghan-chart-32b-v1-1-agent` 一种写法，无中文别名
